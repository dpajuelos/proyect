                                        ...
                                        <div class="card-body">
                                            ...
                                            <form class="forms-sample">
                                                <div class="form-group row">
                                                    <label for="exampleInputUsername2" class="col-sm-2 col-form-label">Usuario</label>
                                                    <div class="col-sm-2">
                                                        <input type="text" class="form-control" id="exampleInputUsername2" placeholder="User">
                                                    </div>
                                                    <label for="exampleInputEmail2" class="col-sm-2 col-form-label">Contraseña</label>
                                                    <div class="col-sm-2">
                                                        <input type="password" class="form-control" id="exampleInputUsername2" placeholder="Password">
                                                    </div>
                                                    <label for="exampleSelectGender" class="col-sm-2 col-form-label">Privilegio</label>
                                                    <div class="col-sm-2">
